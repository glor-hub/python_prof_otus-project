"""
Django settings for vksearch project.
...
WSGI_APPLICATION = "vksearch.wsgi.application"
...
LOGGING = {
    ...
    "loggers": {
        "vkgroup": {"handlers": ["console"], "level": "INFO"},
        "vkapi_services": {"handlers": ["console"], "level": "INFO"},
    },
}
